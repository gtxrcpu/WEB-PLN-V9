<x-layouts.app :title="'Tambah TTD — Leader'">
  <div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900">Tambah Tanda Tangan Unit Anda</h1>
    <p class="text-sm text-gray-600 mt-1">Upload tanda tangan eksklusif untuk persetujuan unit yang Anda pimpin</p>
  </div>
  ...
  <div class="bg-white rounded-xl shadow-lg ring-1 ring-slate-200 p-6">
    <form action="{{ route('leader.signatures.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
      @csrf
      ...
      <div>
        ...
        <input type="text" name="position" value="{{ old('position') }}" required
          placeholder="Contoh: Manager Unit, Kepala Bagian"

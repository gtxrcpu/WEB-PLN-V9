...
<div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg ring-1 ring-slate-200 p-6 mb-6">
        ...
        <form method="GET" action="{{ route('apar.riwayat', $apar->id) }}" class="auto-filter grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
            ...
            <div>
                ...
                <input type="text" name="approver" id="approver" value="{{ request('approver') }}" placeholder="Nama approver..."
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
            </div>
            <div>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                    @if($kLow === 'baik') bg-green-100 text-green-700
                                    @elseif(in_array($kLow, ['tidak baik','tidak_baik','rusak'])) bg-red-100 text-red-700
                                    @elseif($kLow === 'isi ulang') bg-amber-100 text-amber-700
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="font-medium">Belum ada kartu</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>

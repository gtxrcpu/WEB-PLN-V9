...
<head>
    <meta charset="utf-8">
    <title>Kartu Kendali APAT - {{ $apat->barcode ?? $apat->serial_no }}</title>
    ...
    <div class="sheet-a4 bg-white rounded-xl shadow-lg border p-8">
        ...
        <table class="w-full text-sm border-collapse border border-gray-800 mb-0">
            <tr>
                ...
                <td class="border border-gray-800 px-3 py-2">: {{ $apat->lokasi ?? '-' }}</td>
                <td class="border border-gray-800 px-3 py-2 font-bold w-28">JENIS</td>
                <td class="border border-gray-800 px-3 py-2">: {{ $apat->jenis ?? '-' }}</td>
            </tr>
            <tr>
                <td class="border border-gray-800 px-3 py-2 font-bold">KAPASITAS</td>
                <td class="border border-gray-800 px-3 py-2" colspan="3">: {{ $apat->kapasitas ?? '-' }}</td>
            </tr>
        </table>

<x-guest.layouts.guest>
    <x-slot name="title">Pilih Jenis Kartu P3K - Guest Access</x-slot>

    <div class="max-w-7xl mx-auto space-y-6">

        {{-- Back Button --}}
        <x-guest.back-button href="{{ route('guest.p3k.index') }}" />
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-slate-600 mt-2">
                Pilih jenis kartu yang ingin Anda lihat
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <a href="{{ route('guest.p3k.pilih-lokasi', ['jenis' => 'pemeriksaan']) }}"
                ...
                <div class="relative p-6">
                    ...
                    <p class="text-xs text-gray-600 text-center mb-4">
                        Lihat hasil pemeriksaan kelengkapan dan kondisi isi kotak P3K
                    </p>
            ...
            {{-- Pemakaian Kotak P3K --}}
            <a href="{{ route('guest.p3k.pilih-lokasi', ['jenis' => 'pemakaian']) }}"
                ...
                <div class="relative p-6">
                    ...
                    <p class="text-xs text-gray-600 text-center mb-4">
                        Lihat catatan penggunaan obat dan alat dari kotak P3K
                    </p>
            ...
            {{-- Stock P3K --}}
            <a href="{{ route('guest.p3k.pilih-lokasi', ['jenis' => 'stock']) }}"
                ...
                <div class="relative p-6">
                    ...
                    <p class="text-xs text-gray-600 text-center mb-4">
                        Lihat kartu kendali stock obat dan alat P3K
                    </p>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            ...
                            <li><strong>Stock:</strong> Kartu kendali untuk memantau kondisi stock obat dan alat P3K</li>
                        </ul>
                    </div>
                </div>
            </div>

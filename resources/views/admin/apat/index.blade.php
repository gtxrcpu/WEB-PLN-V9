  ...
  <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="space-y-6">
      ...
      @php
        ...
        $statusBaik = $apats->filter(fn($a) => strtolower($a->status) === 'baik')->count();
        $statusPerbaikan = 0; // APAT has no 'perbaikan' status
        $statusRusak = $apats->filter(fn($a) => strtolower($a->status) === 'rusak' || strtolower($a->status) === 'tidak baik')->count();
      @endphp

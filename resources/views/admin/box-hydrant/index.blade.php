  ...
  <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
    ...
    <div class="space-y-6">
      ...
      @php
        ...
        $statusBaik = $boxHydrants->filter(fn($a) => strtolower($a->status) === 'baik')->count();
        $statusPerbaikan = 0; // Box Hydrant has no 'perbaikan' status
        $statusRusak = $boxHydrants->filter(fn($a) => strtolower($a->status) === 'rusak' || strtolower($a->status) === 'tidak baik')->count();
      @endphp

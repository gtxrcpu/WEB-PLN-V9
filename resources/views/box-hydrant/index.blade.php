                    ...
                    <div data-item data-serial="{{ $boxHydrant->serial_no }}" data-barcode="{{ $boxHydrant->barcode }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <a href="{{ route('box-hydrant.kartu-pemeriksaan.create', ['box_hydrant_id' => $boxHydrant->id]) }}"
                                    class="group/btn relative overflow-hidden inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-teal-600 text-white text-sm font-semibold hover:from-cyan-700 hover:to-teal-700 shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/40 transition-all duration-300">
                                    <svg class="w-5 h-5 group-hover/btn:scale-110 transition-transform" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

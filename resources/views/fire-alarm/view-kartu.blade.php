...
<head>
    <meta charset="utf-8">
    <title>Kartu Kendali Fire Alarm - {{ $fireAlarm->barcode ?? $fireAlarm->serial_no }}</title>
...
<div class="max-w-5xl mx-auto px-4 py-6">
    <div class="sheet-a4 bg-white rounded-xl shadow-lg border p-8">
        ...
        {{-- INFO FIRE ALARM (format tabel formal) --}}
        <table class="w-full text-sm border-collapse border border-gray-800 mb-0">
            <tr>
                ...
                <td class="border border-gray-800 px-3 py-2">: {{ $fireAlarm->location_code ?? '-' }}</td>
                <td class="border border-gray-800 px-3 py-2 font-bold w-28">ZONA</td>
                <td class="border border-gray-800 px-3 py-2">: {{ $fireAlarm->zone ?? '-' }}</td>
            </tr>
        </table>

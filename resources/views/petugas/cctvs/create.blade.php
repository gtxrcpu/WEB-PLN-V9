<x-layouts.app :title="'Tambah CCTV'">
<div class="max-w-4xl mx-auto px-4 py-6 space-y-6">

    {{-- Header --}}
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-3xl font-bold tracking-tight text-slate-900">Tambah Perangkat CCTV</h1>
            <p class="text-sm text-slate-600 mt-1">Lengkapi form di bawah untuk registrasi kamera pemantau baru di unit Anda.</p>
        </div>
        <div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form action="{{ route('petugas.cctvs.store') }}" method="POST" class="p-6 sm:p-8 space-y-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                {{-- Unit (hidden, forced to user's unit) --}}
